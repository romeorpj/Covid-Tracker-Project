...
export default function contactpg() {
    return (
        <div className="contactpg_container">
            ...
            <img src={pic} className="contactpg_pic" alt="picture" />
            </div>

            <p className="contactpg_p">For any questions or concerns about coronavirus that have not been addressed, 
            ...
            <form action="/action_page.php" >
              ...
              <input
                type="email"
                name="title"
                className="contactpg_inputEmail"
              />
              <br/>

              <label className="contactpg_label">I am a (please select below):</label>
              <br/>
                <select id="contactpg_select" name="person" size="4">
                <option value="student">student</option>
                <option value="faculty">faculty</option>
                <option value="staff">staff</option>
                <option value="other">other (please specify in comment section)</option>
              </select>
              ...
              />
              <br/>
                <button type="submit" className="contactpg_submit">Submit Form</button>
            </form>
            </div>
