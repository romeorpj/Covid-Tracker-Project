...
function Testing()  {
    return (
        ...
        <ul>Unvaccinated students, faculty, and staff with approved religious or medical exemptions
        : <span>testing is required twice per week with 48 hours between two tests</span>.</ul>
        <ul>Community members who are identified as close contacts of someone recently tested positive for 
            COVID-19: <span>testing is required 3 to 5 days post exposure</span>.
        </ul>
        ...
        <div className="location-section">
            ...
            <ul>Do not eat, drink, chew, smoke, or vape one hour before testing.</ul>
            <ul>Please bring a smartphone or tablet to complete all forms and documents.</ul>
            <ul>Tests taken before 4:00PM should be received the same evening.</ul>
        ...
        <div className="vaccine-requirement">
            ...
            <p className="vaccine-info">
                After considerable research and consultation with public health experts, our college 
                is requiring all students and employees to complete COVID-19 vaccinations for the 2021-2022 
                academic year.
            <br></br>
            <br></br>
        ...
        <div className="proof-section">
            ...
            <p className="vaccination-info">
                ...
                <br></br>
                <br></br>
                Proof of vaccination should have been uploaded to the Vaccination Portal on or before 
                August 13. Proof includes: 
                <br></br>
                <br></br>
                A written certification of vaccination, such as a CDC vacciantion card. Medical documents
                showing the date and type of vaccine adminstered.<span>Do not include any medical or genetic 
                    information with your proof of vaccination.</span>
            </p>
